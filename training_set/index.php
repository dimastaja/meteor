...
<body>
    ...
    <input type="radio" name="type" value="1" checked="checked" />Левое Выс.<br /><br />
    <input type="radio" name="type" value="2"/>Правое Выс.<br /><br />
    <input type="radio" name="type" value="3"/>Двойной (2) Грб.<br /><br />

    <input type="radio" name="type" value="4"/>Плск.Лев.<br /><br />
    <input type="radio" name="type" value="5"/> Плск.Пр. <br /><br />
