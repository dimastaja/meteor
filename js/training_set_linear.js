...
$(function () {
    ...
    function getData()
    {
        var getData;
        $.ajax({
            url: '/datasend/training_search_linear.php?first='+lastDate,
            method: 'GET',
            async: false,
            dataType: 'json',
    ...
    function getDataBack()
    {
        var getData;
        $.ajax({
            url: '/datasend/training_search_linear.php?first='+firstDate+'&back=1',
            method: 'GET',
            async: false,
            dataType: 'json',
            success: function(series){
    ...
    $('#accept').click(function ()
    {
      ...
      //  console.log(drop['data']);
        $.ajax({
            url: '/datasend/training_set_linear.php?TYPE='+visType+'&DROP_COUNT='+dropDescription['DROP_COUNT'] +'&PIK_HEIGHT= '+dropDescription['PIK_HEIGHT']+'&PIK_PLACE='+dropDescription['PIK_PLACE']+'&PIK_COUNT='+dropDescription['PIK_COUNT']+'&IMP_POINT='+dropDescription['IMP_POINT_DATE']+'&DIFF='+dropDescription['DIFF'],
            method: 'GET',
            dataType: 'text',
    ...
    $('#check').click(function ()
    {
        ...
        //console.log(data);
        $.ajax({
            url: '/neural/check.php?DROP_COUNT='+dropDescription['DROP_COUNT'] +'&PIK_HEIGHT= '+dropDescription['PIK_HEIGHT']+'&PIK_PLACE='+dropDescription['PIK_PLACE']+'&PIK_COUNT='+dropDescription['PIK_COUNT']+'&DIFF='+dropDescription['DIFF'],
            method: 'GET',
            dataType: 'text',
            success: function(text){
