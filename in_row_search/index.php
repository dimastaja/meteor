...
<head>
    ...
    <script language="javascript" type="text/javascript" src="/js/in_row_search.js"></script>
...
<body style="padding: 10px;">
   ...
   <?/* <input type="radio" name="type" value="3"/>Дв.Грб.Лев.
    ...
    <p><a class="builder" id="forward">Дальше </a> <br /><br />
    <p><a class="delete_row" id="delete_row">Удалить нахрен </a>
    <br />
   </p>
    <div class="graphWrapper" style="width: 1280px;">
       
            <div class='placeholder1' style='float:left;width:300px;height:300px;'></div>
            <div class='placeholder1' style='float:left;width:300px;height:300px;'></div>
            <div class='placeholder1' style='float:left;width:300px;height:300px;'></div>
            <div class='placeholder1' style='float:left;width:300px;height:300px;'></div>
    </div>
